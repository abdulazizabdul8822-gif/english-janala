...
const displayLevelWord = (words) => {
    ...
    words.forEach((word) => {
        ...
        <div class=" bg-white rounded-xl shadow-sm text-center py-15 px-5 space-y-4">
            ...
            <div class=" text-2xl font-semibold font-bangla">"${word.meaning ? word.meaning : "অর্থ পাওয়া যাইনি"} / ${word.pronunciation ? word.pronunciation : "pronunciation পাওয়া যাইনি"}"</div>
